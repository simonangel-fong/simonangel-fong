...
📚 Studying for the **Certified Kubernetes Security Specialist (CKS)** exam — deepening expertise in cluster hardening, supply chain security, and runtime threat detection.
...
A GitOps project shows how to reduce production release risk through controls across three lifecycle phases: pre-release validation, gradual release deployment, and post-release monitoring.
...
- 🌐 Live Demo: [eks-benchmark.arguswatcher.net](https://eks-benchmark.arguswatcher.net/)
- 📁 Repo: [Project-Automated-Architecture-Benchmark-EKS](https://github.com/simonangel-fong/Project-Automated-Architecture-Benchmark-EKS)

### 🐳 Automated Architecture Benchmark — ECS

Implemented the same benchmark architecture on **AWS ECS**, exploring container orchestration with managed infrastructure.
